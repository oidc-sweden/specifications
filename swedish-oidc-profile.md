...
### Version: 1.0 - draft 04 - 2023-12-08
...
| `scope` | Indicates the scopes requested. See [2.2.1](#the-scope-parameter) below. | REQUIRED |
| `state` | Random string generated by the Relying Party. The state is used to protect against CSRF attacks. This value is returned to the Relying Party in the authentication response. See [2.2.2](#the-state-parameter) below. | REQUIRED |
...
| `acr` | Authentication Context Class Reference. See [3.2.1.3](#the-acr-claims) below. | REQUIRED the `acr` claim was requested as an essential claim (see [2.1](#authentication-request-parameters) above), otherwise OPTIONAL. |
